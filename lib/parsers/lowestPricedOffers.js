...
function parseLowestPricedOffers(offerData) {
    // console.log(JSON.stringify(offerData, null, 4));
    const identifier = offerData.GetLowestPricedOffersForASINResponse.GetLowestPricedOffersForASINResult.Identifier;
    const summary = offerData.GetLowestPricedOffersForASINResponse.GetLowestPricedOffersForASINResult.Summary;
    const offers = forceArray(offerData.GetLowestPricedOffersForASINResponse.GetLowestPricedOffersForASINResult.Offers.Offer);

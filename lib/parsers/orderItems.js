...
const parseOrderItems = (orderItemsList) => {
    ...
    // console.log(orderItemsList.ListOrderItemsResponse.ListOrderItemsResult.OrderItems.OrderItem)
    // const arr = forceArray(orderItemsList.OrderItems.OrderItem);
    const arr = forceArray(orderItemsList.ListOrderItemsResponse.ListOrderItemsResult.OrderItems.OrderItem);

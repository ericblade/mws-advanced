...
const parseMarketplaceData = (marketplaceData) => {
    // console.log(marketplaceData.ListMarketplaceParticipationsResponse.ListMarketplaceParticipationsResult.ListParticipations.Participation)
    // destructure result.ListParticipations.Participation to marketParticipationsTemp
    const { ListMarketplaceParticipationsResult: { ListParticipations: { Participation: marketParticipationsTemp } } } = marketplaceData.ListMarketplaceParticipationsResponse;
    // destructure result.ListMarketplaces.Marketplace to marketsTemp

    // console.log(marketplaceData.ListMarketplaceParticipationsResponse.ListMarketplaceParticipationsResult.ListMarketplaces.Marketplace)
    // const { ListMarketplaces: { Marketplace: marketsTemp } } = marketplaceData;
    const { ListMarketplaceParticipationsResult: { ListMarketplaces: { Marketplace: marketsTemp } } } = marketplaceData.ListMarketplaceParticipationsResponse;

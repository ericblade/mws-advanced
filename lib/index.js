...
const { MWS_ENDPOINTS } = require('./endpoints/constants');
 ...
 * @param {string} host Override default MWS host (mws.amazonservices.com), see https://docs.developer.amazonservices.com/en_US/dev_guide/DG_Endpoints.html
 * @param {string} host Override default MWS port (443)
 * @returns {mws-simple}
 */
const init = ({
    region = 'NA',

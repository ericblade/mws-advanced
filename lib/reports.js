 ...
 * TO DO: WRITE DOCUMENTATION
 */
const manageReportSchedule = parseEndpoint(manageReportScheduleParser)('ManageReportSchedule');

/**
 * TO DO: WRITE DOCUMENTATION
 */
const updateReportAcknowledgements = parseEndpoint(updateReportAcknowledgementsParser)('UpdateReportAcknowledgements');

/**
 * TO DO: WRITE DOCUMENTATION
 */
const getReportScheduleList = parseEndpoint(getReportScheduleListParser)('GetReportScheduleList');

 ...
 * @param {string} MarketplaceId ID of Marketplace (see getMarketplaces)
 * @param {string} IdType Type of lookup to perform: ASIN, GCID, SellerSKU, UPC, EAN, ISBN, JAN
 * @param {string[]} IdList List of codes to perform lookup on
 */
 ...
 *
 * @param {ProductQuery} options see https://docs.developer.amazonservices.com/en_UK/products/Products_GetMatchingProductForId.html
 * @returns {Product[]}
 */

    ...
    GetReportList: {
        ...
        params: {
            ...
            ReportTypeList: {
                type: 'xs:string',
                required: false,
                values: [...constants.REQUEST_REPORT_TYPES, ...constants.NOREQUEST_REPORT_TYPES, ...constants.SCHEDULED_REPORT_TYPES ],
                list: 'ReportTypeList.Type',
            },
            Acknowledged: {
                type: 'xs:boolean',
    ...
    GetReportScheduleCount: {
        ...
        params: {
            ReportTypeList: {
                type: 'xs:string',
                required: false,
                values: [ ...constants.SCHEDULED_REPORT_TYPES, ...constants.REQUEST_REPORT_TYPES ],
                list: 'ReportTypeList.Type',
            },
        },
        returns: {
